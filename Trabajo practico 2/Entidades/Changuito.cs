...
namespace Entidades_2018
{
    ...
    public sealed class Changuito
    {
        ...
        {
            return this.Mostrar(this, ETipo.Todos).ToString();
        }

        /// <summary>
        /// Agregará un elemento a la lista
        /// </summary>
        /// <param name="c">Objeto de tipo Changuito donde se agregará el elemento</param>
        /// <param name="p">Objeto de tipo Producto a agregar</param>
        /// <returns></returns>
